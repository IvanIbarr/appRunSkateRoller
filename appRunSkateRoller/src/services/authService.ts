  ...
  async isAuthenticated(): Promise<boolean> {
    try {
      ...
      try {
        ...
        // mantener sesión local en web para permitir navegación sin backend.
        if (isWeb) {
          console.warn('Error verificando autenticación, usando sesión local:', error);
          return true;
        }
