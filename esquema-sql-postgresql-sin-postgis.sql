...
-- Versión SIN PostGIS (para instalación inicial)
-- ============================================================

-- Extensiones necesarias
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
-- PostGIS se instalará después con: CREATE EXTENSION postgis;
...
-- Índices geoespaciales (sin PostGIS por ahora, se crearán después)
CREATE INDEX idx_rutas_origen_lat ON rutas(origen_lat);
CREATE INDEX idx_rutas_origen_lng ON rutas(origen_lng);
CREATE INDEX idx_rutas_destino_lat ON rutas(destino_lat);
CREATE INDEX idx_rutas_destino_lng ON rutas(destino_lng);
...
-- Índices geoespaciales básicos (sin PostGIS)
CREATE INDEX idx_puntos_gps_lat ON puntos_gps(lat);
CREATE INDEX idx_puntos_gps_lng ON puntos_gps(lng);
...
-- Índices geoespaciales básicos (sin PostGIS)
CREATE INDEX idx_eventos_lat ON eventos(punto_encuentro_lat);
CREATE INDEX idx_eventos_lng ON eventos(punto_encuentro_lng);
