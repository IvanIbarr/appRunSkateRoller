...
class MarketingComprarPagoScreen extends StatefulWidget {
  const MarketingComprarPagoScreen({super.key, required this.draft});

  final MarketingCheckoutDraft draft;

  @override
  State<MarketingComprarPagoScreen> createState() => _MarketingComprarPagoScreenState();
}

class _MarketingComprarPagoScreenState extends State<MarketingComprarPagoScreen> {
  String? _forma;
  ...
  static const _options = <({String key, String label, String hint})>[
    ...
    (key: 'transferencia', label: 'Transferencia bancaria', hint: 'En producción: CLABE / referencia.'),
    (key: 'otro', label: 'Otro / manual', hint: 'Solo para completar el flujo demo.'),
  ];
  ...
  void _confirmar() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Pedido demo confirmado: ${widget.draft.brandModel} · \$${widget.draft.priceMx} MXN · $_forma'),
      ),
    );
